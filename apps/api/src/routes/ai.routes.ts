...
router.post("/generate/stream", validate({ body: aiGenerateSchema }), aiController.generateStream);
router.post("/improve/stream", validate({ body: aiImproveSchema }), aiController.improveStream);
